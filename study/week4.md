...
Day 20 (12/1)
---
오늘은 지난주에 이어 Data Visualization에 대해 배웠다.  
matplotlib이나 seaborn 외에도 사용할 수 있는 여러 library들과 interactive 시각화, 각 좌표계 등 특수한 상황에서 사용할 수 있는 여러 기법들을 다뤘다.  
소개된 library와 method들이 워낙에 많아서 하나하나 외우기보다는 어떤 종류의 시각화를 할 수 있는지 눈에 익혀두는 느낌으로 공부했다.  

원래 금요일은 스터디를 진행하는 날이지만 다들 학습 진도가 조금씩 남아있어서 이번주는 생략하고 다음주에 진행하기로 했다.  
나는 Data Vizualization 강의만 들으면 시간 여유가 많이 남을 것 같아서 이번주 심화 과제를 풀어봤다.  
SGNS 구현 코드에 빈 칸을 채워넣는 과제였는데, 주석으로 힌트가 많이 달려있어서 무난하게 해결했다.  

스페셜 피어세션 시간에 다른 조에 속한 분들을 만나서 얘기를 나눴는데, 강의를 빠르게 들으면서 다른 도메인 강의까지 듣는 분도 계셔서 인상 깊었다.  
이번주 강의에 대한 소감을 나누기도 했는데, 대체로 강의와 과제 내용을 다 이해하기 어렵다는 분위기였다.  
나도 강의에서 배운 개념들을 모두 샅샅이 설명하라고 하면 못하겠지만, 그래도 지난주에 비하면 내용이 훨씬 쉬웠고 과제도 무난했던 것 같다.  
너무 조급해지지 않고 지금같은 페이스를 유지해나가되, 지금보다 익숙해지면 천천히 속도를 높이면 되겠다.  

8주차에 첫 프로젝트를 마치면 팀 리빌딩을 하는데, 피어세션 때 지금 팀을 그대로 유지하는 것에 대해 얘기를 나눴다.  
며칠 전에 처음 제안했을 때 다들 긍정적인 분위기였고 오늘도 동의하는 의견이 많이 나와서 그대로 유지될 가능성이 높아보인다.  
다양한 사람들과 팀을 이뤄보면서 작업하는 것도 좋은 경험이겠지만, 이미 팀원들과 친해져서 재밌게 활동 중이라 욕심을 내게 된다.  
팀을 그대로 유지한다는 가정 하에 마지막 프로젝트 때 어떤 주제를 할지 각자 고민해보기로 하고 피어세션을 마쳤다.  

그 후에 오피스아워 때 조교님께서 이번주 과제들에 대해 해설을 해 주셨다.  
일반 과제와 심화 과제 모두 잘 해결했고, 크게 어려운 부분은 없었어서 해설도 쉽게 받아들였다.  
과제 해설 후에 추천 시스템이라는 도메인에 대한 여러 질문들에 답해주셨는데, RecSys는 분야마다 사용하는 기법 등에 차이가 크다고 한다.  
어제도 느꼈지만 추천 시스템은 특정 도메인에 특화된 역량이 중요한 것 같다.  

>  오늘의 질문 횟수: 1  
>  오늘의 답변 횟수: 1  

+ ##### 키워드: Data Visualization, 페이스 유지
